    ...
    return BlocBuilder<JobBloc, JobState>(builder: (_, state) {
      return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          backgroundColor:
          job.acceptanceStatus.toLowerCase().trim() == 'accepted'
              ? Colors.green
              : Colors.grey,
          onPressed: () async {
            final event = job.acceptanceStatus.toLowerCase().trim() ==
                'accepted'
                ? JobUpdate(
              Job(
                jobId: job.jobId,
            ...
            context.read<JobBloc>().add(event);
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Job Name: ${job.jobName}", style: _kJobTitleTextStyle),
